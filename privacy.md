...
/ ("us", "we", or "our") operates the https://github.com/Yin-Yin/eu-bot
website and the / mobile application (hereinafter referred to as the
"Service").

This page informs you of our policies regarding the collection, use, and
disclosure of personal data when you use our Service and the choices you have
associated with that data. The Privacy Policy for / has been created with the
help of TermsFeed.
...
-----------
  ...
  * Service
    ...
    Service means the https://github.com/Yin-Yin/eu-bot website and the /
    mobile application operated by /
...
If you are located outside Germany and choose to provide information to us,
please note that we transfer the data, including Personal Data, to Germany and
process it there.
...
If you have any questions about this Privacy Policy, please contact us:
  ...
  * By visiting this page on our website: https://github.com/Yin-Yin/eu-
    bot/issues
