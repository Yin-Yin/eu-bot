...
app.get('/', function(request, response) {
  response.send('Hi there, this is the webhook for the quote bot. For more info got to: <a href="https://github.com/Yin-Yin/eu-bot/">Quote Bot GitHub Page</a>');
});

app.post('/dialogflow', function(request, response) {
  dialogflowModule.handleRequest(request).then((response) => response.send(response));
